SCHEEM = (function(){
  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        "sexpression": parse_sexpression,
        "anychar": parse_anychar,
        "validchar": parse_validchar,
        "cleanatom": parse_cleanatom,
        ...
        "quote": parse_quote,
        "cleanquote": parse_cleanquote,
        "list": parse_list,
        "cleanlist": parse_cleanlist,
        "whitespace": parse_whitespace,
        "newline": parse_newline,
        "leftparen": parse_leftparen,
        "rightparen": parse_rightparen
      };
      ...
      function parse_sexpression() {
        ...
        result0 = parse_cleanquote();
        if (result0 === null) {
          result0 = parse_cleanatom();
          if (result0 === null) {
            result0 = parse_cleanlist();
          }
        }
        return result0;
      }
      ...
      function parse_comment() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, comment) { return comment; })(pos0, result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_decimal() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, i, d) { return parseFloat(i.join("") + d.join("")); })(pos0, result0[0], result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_list() {
        ...
        pos0 = pos;
        pos1 = pos;
        result0 = parse_leftparen();
        if (result0 !== null) {
          result1 = parse_sexpression();
          if (result1 !== null) {
            result2 = [];
            result3 = parse_sexpression();
            while (result3 !== null) {
              result2.push(result3);
              result3 = parse_sexpression();
            }
            if (result2 !== null) {
              result3 = parse_rightparen();
              if (result3 !== null) {
                result0 = [result0, result1, result2, result3];
              } else {
                result0 = null;
